...
class App_Model_Entity_Galeria_Galerias_Banners extends App_Model_Entity_Galeria_Abstract 
{
	protected $codigo = 'banners';
	protected $nome = 'Banners';

	public function init()
	{
		$this->filePath = Zend_Registry::get('config')->paths->site->file .'/images/banners';
		$this->basePath = Zend_Registry::get('config')->paths->site->base .'/images/banners';
	}
