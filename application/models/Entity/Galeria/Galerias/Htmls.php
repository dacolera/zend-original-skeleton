...
class App_Model_Entity_Galeria_Galerias_Htmls extends App_Model_Entity_Galeria_Abstract 
{
	protected $codigo = 'htmls';
	protected $nome = 'Htmls';

	public function init()
	{
		$this->filePath = Zend_Registry::get('config')->paths->site->file .'/images/htmls';
		$this->basePath = Zend_Registry::get('config')->paths->site->base .'/images/htmls';
	}
