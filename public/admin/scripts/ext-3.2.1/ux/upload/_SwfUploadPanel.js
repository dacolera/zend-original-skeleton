...
Ext.ux.SwfUploadPanel = Ext.extend(Ext.grid.GridPanel, {
	 ...
	 */
	strings: {
        text_add: 'Adicionar Arquivo(s)',
        text_upload: 'Enviar Arquivo(s)',
        text_cancel: 'Cancelar Upload',
        text_clear: 'Remover Arquivos',
        text_progressbar: 'Progress Bar',
        text_remove: 'Remover Arquivo',
        text_remove_sure: 'Deseja realmente remover o(s) arquivo(s) selecionado(s)?',
        text_error: 'Erro',
        text_uploading: 'Enviando arquivo: {0} ({1} of {2})',
        header_filename: 'Arquivo',
        header_size: 'Tamanho',
        ...
        error_size_exceeded: ' ultrapassa o limite de tamanho permitido que é de {0}.',
        error_zero_byte_file: 'Zero byte file selected.',
        error_invalid_filetype: 'Extensão de arquivo não permitida.',
        error_file_not_found: 'Arquivo não encontrado 404.',
	 ...
	 */ 
	file_post_name: "Arquivos",		  // Default name
	/**
...
//			width: this.width - 7
	...
	fileDialogStart: function(obj) {
		...
		this.fireEvent('fileDialogStart', this, this);
	},
